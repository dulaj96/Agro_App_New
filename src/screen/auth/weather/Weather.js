  ...
  return (
    <SafeAreaView
      ...
      <View style={styles.searchSection1}>
        <View
          style={[
            styles.searchSection2,
            {backgroundColor: showSearch ? COLORS.secondary : 'transparent'},
          ]}>
          {showSearch ? (
            <TextInput
          ...
          <View
            ...
            {locations.map((loc, index) => {
              ...
              let borderClass = showBorder
                ? ' borderBottomWidth: 1, borderBottomColor: COLORS.bgGrey(0.3)'
                : '';
              return (
                <TouchableOpacity
      ...
      <View style={styles.forecastView1}>
        ...
        <View style={{justifyContent: 'center', alignItems: 'center'}}>
          ...
          <Text style={{color: '#524f47', fontSize: 22, marginTop: 10}}>
      ...
      {/*    <Text style={{color: 'black', fontWeight: '500', marginLeft: 5}}>*/}
      {/*      Daily Forecast*/}
      {/*    </Text>*/}
      {/*  </View>*/}
      {/*  <ScrollView*/}
